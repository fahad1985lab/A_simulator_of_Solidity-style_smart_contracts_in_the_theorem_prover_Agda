...
testLedger 1 .purefunction "checkVoter" msg  =  checkMsgInRangePure Max_Address msg λ voter  → theMsg (nat 0)
testLedger 1 .purefunction "voteResult" msg  =  checkMsgInRangePure Max_Uint msg λ voter → theMsg (nat 0)
testLedger 1 .purefunctionCost "checkVoter" msg  = 1
testLedger 1 .purefunctionCost "voterResult" msg = 1
...
testLedger 1 .fun "vote" msg = checkMsgInRange Max_Uint msg λ candidate → 
                               ...
                               λ addr → exec (callPure 1 "checkVoter" (nat addr)) 
                               (λ _ → 1) λ msgResult → checkMsgOrErrorInRange Max_Bool msgResult
